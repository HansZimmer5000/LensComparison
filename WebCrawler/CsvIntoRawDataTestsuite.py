...
class CsvIntoRawDataTestSuite(unittest.TestCase):
    ...
    def setUp(self):
        self.__class__.PROJECT_MAIN_DIR = 'C:\\Users\\Michael\\IdeaProjects\\NikonLensComparison\\'
        ...
        self.__class__.RAWRESPONSE_FILES_FULLPATH_SET = {
            self.__class__.RAWRESPONSE_FILES_DIR + "rawResponseData 1-4.csv",
            self.__class__.RAWRESPONSE_FILES_DIR + "rawResponseData 5-7.csv",
            self.__class__.RAWRESPONSE_FILES_DIR + "rawResponseData 8-11.csv",
        ...
        self.__class__.RAWRESPONSE_TWELVE_SIXTY_ENTRY_1 = GhExamples.TESTDATA_PRODSITE_RAW_RESPONSE_TWELVE_SIXTY_ENTRY_1
